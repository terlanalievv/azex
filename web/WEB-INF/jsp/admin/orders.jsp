...
<div class="page-wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="page-content fade-in-up">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Sifarisler</div>
                </div>
                <div class="ibox-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <th>Musterinin odediyi mebleg</th>
                            <th>Azex odediyi mebleg</th>
                            <th>Balans</th>
                        </tr>
                        </thead>
                        ...
                        <tbody>
                        <c:choose>
                            <c:when test="${fn:length(requestScope.customerOrders) > 0}">
                                <c:forEach items="${requestScope.customerOrders}" var="order" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            <fmt:formatNumber type="number" value="${order.customerPaidAmount}"
                                                              minFractionDigits="2"
                                                              maxFractionDigits="2"/>
                                        </td>
                                        <td>
                                            <fmt:formatNumber type="number" value="${order.azexPaidAmount}"
                                                              minFractionDigits="2"
                                                              maxFractionDigits="2"/>
                                        </td>
                                        <td>
                                            <fmt:formatNumber type="number" value="${order.customer.balance}"
                                                              minFractionDigits="2"
                                                              maxFractionDigits="2"
                            ...
                            <c:otherwise>
                                <tr>
                                    <td colspan="5">Bu musterinin sifarisleri yoxdu!</td>
                                </tr>
                            </c:otherwise>
                        </c:choose>
